...
Validación de entradas: Manejo de errores para evitar cierres inesperados del programa.

Sistema de arbitraje: Comparación lógica de opciones (Piedra, Papel, Tijera) mediante condicionales estructurados.

Optimización modular: Código organizado en funciones para facilitar su mantenimiento y escalabilidad.
# Descripción del problema
Se requiere una solución informática que automatice la lógica de arbitraje del juego, garantizando una interacción fluida con el usuario, la generación aleatoria de respuestas por parte de la máquina y un manejo robusto de errores en las entradas.

# Relación con los contenidos de la asignatura
Este proyecto integra los aprendizajes de las cuatro unidades:

Unidad 1 y 2: Lógica algorítmica aplicada mediante estructuras condicionales y de control.

Unidad 3: Optimización mediante el uso de funciones y listas.

Unidad 4: Diseño basado en arquitectura de capas (separación de lógica de negocio y control).

# Explicación del sistema desarrollado
El sistema es una aplicación de consola que sigue un flujo de control estructurado:

Entrada: Captura y valida la opción del usuario.

Procesamiento: Genera una jugada aleatoria y ejecuta el motor de arbitraje para determinar el ganador de la ronda.

Salida: Muestra resultados y actualiza el marcador en tiempo real.
(Aquí puedes poner las imágenes de tus 3 diagramas: Arquitectura, Casos de Uso y Flujo).

# Reflexión sobre el impacto de la tecnología
La automatización mediante lógica de programación permite optimizar procesos y reducir la margen de error en la toma de decisiones. Este sistema es una demostración práctica de cómo los algoritmos estructurados son la base fundamental para el desarrollo de sistemas complejos.
...
Diagrama de Casos de Uso: Representa las interacciones principales del usuario con el sistema.
